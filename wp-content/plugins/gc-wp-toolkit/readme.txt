...
1. Install the plugin:
    * Manually: Clone contents of this repository and create "gc-wp-toolkit" folder under wp-content/plugins/
    * Easily: Use the [GitHub Updater plugin](https://github.com/afragen/github-updater/releases) in the Admin to install this plugin from its [Bitbucket repository](https://bitbucket.org/goldencomm/gc-wp-toolkit)
